...
function renderQuestion(){
    ...
    if(learn && !sess.revealed) h += '<div class="gate"><b>Jot a quick note (optional):</b> why do you think that&rsquo;s the answer?<textarea id="gate-txt" placeholder="A few words if you want — or just hit Check.">'+esc(sess.explain[p.id]||'')+'</textarea></div>';
